...
// DontCrack 通用 Linux (manylinux) 版
// https://github.com/FasterEdge/DontCrack4ManyLinux
// tyza66
...
import (
	...
	dclog "github.com/FasterEdge/DontCrack4ManyLinux/log"
	"io"
	"log"
	"net"
	"net/http"
...
const rootMsg = "DontCrack_linux By FasterEdge"
...
func Start(cfg config.Config) {
	...
	// 输出启动Logo和版本等欢迎信息
	log.Printf(logo)
	log.Printf("DontCrack_linux for manylinux v%s 启动中...\n", cfg.Version)
